...
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "8S", "3S", "JH", "7H", "5H", "QD", "JD", "JC", "3C"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "QD", "JD"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "QD", "JD"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "QD", "JD"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "QD"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "QD"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "QD", "JD"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
...
sleep 1
curl -i -H "Content-Type: application/json" -X POST -d '{ "cards_played" : ["10S", "JH", "QD", "JC", "6C", "2D", "10S"], "board" : 1, "table" : 1 }' http://localhost:5000/snapshots
sleep 1
