...
#line 753 "grammar.tab.c" /* yacc.c:355  */
};
...
#line 769 "grammar.tab.c" /* yacc.c:358  */
...
{
       0,   684,   684,   691,   706,   714,   745,   763,   767,   782,
     798,   799,   803,   804,   816,   835,   867,   879,   887,   918,
     919,   928,   940,   941,   944,   945,   947,   991
};
#endif
...
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, void *scanner, graph_t *graph)
{
  ...
  switch (yytype)
    {
          case 3: /* PARSE_URL  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1613 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 4: /* IDENTIFIER  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1619 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 5: /* REF  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1625 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 6: /* PADREF  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1631 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 7: /* BINREF  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1637 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 8: /* ASSIGNMENT  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1643 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 9: /* LINK  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1649 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 17: /* element  */
#line 654 "./grammar.y" /* yacc.c:1257  */
      {	gst_object_unref (((*yyvaluep).ee));		}
#line 1655 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 18: /* elementary  */
#line 650 "./grammar.y" /* yacc.c:1257  */
      {	if(((*yyvaluep).cc))
		  gst_parse_free_chain(((*yyvaluep).cc));	}
#line 1662 "grammar.tab.c" /* yacc.c:1257  */
        break;
...
#line 650 "./grammar.y" /* yacc.c:1257  */
      {	if(((*yyvaluep).cc))
		  gst_parse_free_chain(((*yyvaluep).cc));	}
#line 1669 "grammar.tab.c" /* yacc.c:1257  */
        break;
...
#line 650 "./grammar.y" /* yacc.c:1257  */
      {	if(((*yyvaluep).cc))
		  gst_parse_free_chain(((*yyvaluep).cc));	}
#line 1676 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 21: /* link  */
#line 652 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_free_link (((*yyvaluep).ll));	}
#line 1682 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 22: /* pads  */
#line 655 "./grammar.y" /* yacc.c:1257  */
      {	GSList *walk;
...
#line 655 "./grammar.y" /* yacc.c:1257  */
      {	GSList *walk;
		for(walk=((*yyvaluep).pp);walk;walk=walk->next)
		  gst_parse_strfree (walk->data);
		g_slist_free (((*yyvaluep).pp));		}
#line 1700 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 24: /* reference  */
#line 653 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_free_reference(&(((*yyvaluep).rr)));}
#line 1706 "grammar.tab.c" /* yacc.c:1257  */
        break;
...
#line 650 "./grammar.y" /* yacc.c:1257  */
      {	if(((*yyvaluep).cc))
		  gst_parse_free_chain(((*yyvaluep).cc));	}
#line 1713 "grammar.tab.c" /* yacc.c:1257  */
        break;
...
#line 655 "./grammar.y" /* yacc.c:1257  */
      {	GSList *walk;
		for(walk=((*yyvaluep).pp);walk;walk=walk->next)
		  gst_parse_strfree (walk->data);
		g_slist_free (((*yyvaluep).pp));		}
#line 1722 "grammar.tab.c" /* yacc.c:1257  */
        break;

    case 27: /* binopener  */
#line 649 "./grammar.y" /* yacc.c:1257  */
      {	gst_parse_strfree (((*yyvaluep).ss));		}
#line 1728 "grammar.tab.c" /* yacc.c:1257  */
        break;
...
#line 999 "./grammar.y" /* yacc.c:1906  */
